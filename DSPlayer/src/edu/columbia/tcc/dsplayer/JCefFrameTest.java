...
//
//public class JCefFrameTest extends JFrame {
//
...
//    private static JCefFrameTest frame = null;
//
//    // hilos 
...
//    private JCefFrameTest(String startURL, boolean useOSR, boolean isTransparent) {
...
//        frame = new JCefFrameTest("https://magpcss.org/ceforum/viewtopic.php?f=7&t=15187", OS.isLinux(), false); // Panel visual de reproduccion (aqui se ven los contneidos)
//       frame.browerUI_.getSendKeyEvent(kEvent);
//
////frame.browerUI_.addMouseWheelListener(new MouseWheelListener() {
////            @Override
